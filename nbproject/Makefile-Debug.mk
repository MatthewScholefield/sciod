...
${OBJECTDIR}/source/NeuralNet.o: source/NeuralNet.cpp
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/NeuralNet.o source/NeuralNet.cpp

${OBJECTDIR}/source/Node.o: source/Node.cpp
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/Node.o source/Node.cpp

${OBJECTDIR}/source/Row.o: source/Row.cpp
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/Row.o source/Row.cpp
...
${TESTDIR}/tests/catch.o: tests/catch.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/catch.o tests/catch.cpp


${TESTDIR}/tests/intentTests.o: tests/intentTests.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/intentTests.o tests/intentTests.cpp
...
${OBJECTDIR}/source/NeuralNet_nomain.o: ${OBJECTDIR}/source/NeuralNet.o source/NeuralNet.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++14 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/NeuralNet_nomain.o source/NeuralNet.cpp;\
	else  \
...
${OBJECTDIR}/source/Node_nomain.o: ${OBJECTDIR}/source/Node.o source/Node.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++14 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/Node_nomain.o source/Node.cpp;\
	else  \
...
${OBJECTDIR}/source/Row_nomain.o: ${OBJECTDIR}/source/Row.o source/Row.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++14 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/Row_nomain.o source/Row.cpp;\
	else  \
